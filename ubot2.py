...
# --- override session file dari ENV (kalau dipanggil lewat bot_resmi.py) ---
session_override = os.getenv("SESSION_FILE")
if session_override:
    session_file = session_override
...
session_file = "userbot2.session" #A sama B sama ini jangan di ubah
